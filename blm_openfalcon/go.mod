module github.com/taosdata/Bailongma/blm_openfalcon

go 1.14

replace github.com/open-falcon/falcon-plus => github.com/open-falcon/falcon-plus v0.2.2-0.20210717135504-29238ca68d42
